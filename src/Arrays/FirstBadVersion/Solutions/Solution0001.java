...
/**
 * Solution Notes by @wilsonplau
 * - A variation of BinarySearch that requires finding an edge instead of a values
 * - Search always checks lower value for edge, so we need to handle the case when it is element 1
 * - Otherwise, this is quite similar to normal binary search
 */
